#!/bin/sh
# System startup script to start the klipper_raspi_host_mcu firmware

### BEGIN INIT INFO
# Provides:          klipper_raspi_host_mcu
# Required-Start:    $local_fs
# Required-Stop:
# Default-Start:     3 4 5
# Default-Stop:      0 1 2 6
# Short-Description: klipper_raspi_host_mcu daemon
# Description:       Starts the raspi_host_mcu for Klipper.
### END INIT INFO

PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
DESC="klipper_raspi_host_mcu startup"
NAME="klipper_raspi_host_mcu"
